...
```bash
python detection.py --att 0.2 --decay 2 --ground_truth_file data/GT/edge_level_gt/groundTruthC3.txt --data_path data/C3 --experiment_prefix Test-C3 --param_path experiments/Train-C3 --model_index 99 --time_range 2018-4-6T00:00:00-04:00 2018-4-15T00:00:00-04:00
```
The default parameters (without any training) can serve as the baseline
```bash
python detection.py --att 0.2 --decay 2 --ground_truth_file data/GT/edge_level_gt/groundTruthC3.txt --data_path data/C3 --experiment_prefix Test-C3 --time_range 2018-4-6T00:00:00-04:00 2018-4-15T00:00:00-04:00
```
...
```bash
python detection.py --att 0 --decay 0 --ground_truth_file data/GT/edge_level_gt/groundTruthT3.txt --data_path data/T3 --experiment_prefix Test-T3 --param_path experiments/Train-T3 --model_index 99 --time_range 2018-4-10T00:00:00-04:00 2018-4-15T00:00:00-04:00
```

The default parameters (without any training) can serve as the baseline.
```bash
python detection.py --att 0 --decay 0 --ground_truth_file data/GT/edge_level_gt/groundTruthT3.txt --data_path data/T3 --experiment_prefix Test-T3 --time_range 2018-4-10T00:00:00-04:00 2018-4-15T00:00:00-04:00
```
...
```bash
python detection.py --att 0 --decay 0 --ground_truth_file data/GT/edge_level_gt/groundTruthTH3.txt --data_path data/TH3 --experiment_prefix Test-TH3 --param_path experiments/Train-TH3 --model_index 99 --time_range 2018-4-10T00:00:00-04:00 2018-4-15T00:00:00-04:00
```

The default parameters (without any training) can serve as the baseline
```bash
python detection.py --att 0 --decay 0 --ground_truth_file data/GT/edge_level_gt/groundTruthTH3.txt --data_path data/TH3 --experiment_prefix Test-TH3 --time_range 2018-4-10T00:00:00-04:00 2018-4-15T00:00:00-04:00
```
...
python detection.py --att 0.2 --decay 2 --ground_truth_file data/GT/edge_level_gt/groundTruthC5.txt --data_path data/C5 --experiment_prefix Test-C5 --param_path experiments/Train-C5 --model_index 99 --time_range 2019-5-10T08:00:00-04:00 2019-5-17T18:00:00-04:00

## The default parameters (without any training) can serve as the baseline
python detection.py --att 0.2 --decay 2 --ground_truth_file data/GT/edge_level_gt/groundTruthC5.txt --data_path data/C5 --experiment_prefix Test-C5 --time_range 2019-5-10T08:00:00-04:00 2019-5-17T18:00:00-04:00
```
...
### Detection (Testing)
```
python detection.py --att 0.2 --decay 2 --ground_truth_file data/GT/edge_level_gt/groundTruthT5.txt --data_path data/T5 --experiment_prefix Test-T5 --param_path experiments/Train-T5 --model_index 99 --time_range 2019-5-10T08:00:00-04:00 2019-5-17T18:00:00-04:00

python detection.py --att 0.2 --decay 2 --ground_truth_file data/GT/edge_level_gt/groundTruthT5.txt --data_path data/T5 --experiment_prefix Test-T5 --param_path experiments/Train-T5-2024-04-30-02-09-48 --model_index 99 --time_range 2019-5-10T08:00:00-04:00 2019-5-17T18:00:00-04:00

python detection.py --att 0.2 --decay 2 --ground_truth_file data/GT/edge_level_gt/groundTruthT5.txt --data_path data/T5 --experiment_prefix Test-T5 --time_range 2019-5-10T08:00:00-04:00 2019-5-17T18:00:00-04:00
```
...
### Detection (Testing)
```
python detection.py --att 0.2 --decay 2 --ground_truth_file data/GT/edge_level_gt/groundTruthTH5.txt --data_path data/TH5 --experiment_prefix Test-TH5 --param_path experiments/Train-TH5 --model_index 99 --time_range 2019-5-10T08:00:00-04:00 2019-5-17T18:00:00-04:00

## The default parameters (without any training) can serve as the baseline
python detection.py --att 0 --decay 0 --ground_truth_file data/GT/edge_level_gt/groundTruthTH5.txt --data_path data/TH5 --experiment_prefix Test-TH5 --time_range 2019-5-10T08:00:00-04:00 2019-5-17T18:00:00-04:00
```
...
### Detection (Testing)
```
python detection.py --att 0 --decay 0 --ground_truth_file data/GT/edge_level_gt/groundTruthOPTC.txt --data_path data/optc --experiment_prefix Test-OPTC
```
