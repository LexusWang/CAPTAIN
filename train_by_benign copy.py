...
def start_experiment(args):
    ...
    if (mode == "train"):
        ...
        # #edge tuning
        # mo.white_name_set = {'10.0.4.1', '208.17.90.10', '128.55.12.73', '128.55.12.10', '66.252.21.131', '129.33.46.231', '8.15.32.34', '0.0.0.0', '208.75.170.1', '65.214.39.18', '128.55.12.122'}
        ...
        for epoch in range(epochs):
            ...
            for event in tqdm.tqdm(events):
                ...
                if s_labels:
                    ...
                    propagation_chains.append(mo.Nodes[event.src].propagation_chain)
                    pdb.set_trace()

                if o_labels:
                    node_gradients.extend(o_labels)
                    propagation_chains.append(mo.Nodes[event.dest].propagation_chain)
                    pdb.set_trace()
