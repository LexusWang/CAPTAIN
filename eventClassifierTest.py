...
ec = eventClassifier('groundTruth5.txt')
...
ec.analyzeFile(open('/home/weijian/weijian/projects/ATPG/experiments/E51-train_by_benign-2022-09-06-21-31-57/train/alarms/alarms-epoch-0.txt','r'))
