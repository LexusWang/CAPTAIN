...
def build_benign_graph(args):
    ...
    ##### Load File Names #####
    volume_list = ["../data/raw/ta1-cadets-e3-official.json/ta1-cadets-e3-official.json"]
        ...
        with open(volume,'r') as fin:
            for line in fin:
                ...
                if record_type == "Event":
                    ...
                    if src and G.has_node(src) and dest and G.has_node(dest):
                        G.add_edge(src, dest)
                    if src and G.has_node(src) and dest2 and G.has_node(dest2):
                        G.add_edge(src, dest2)
